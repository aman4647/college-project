...
<form class="form-horizontal" method="POST"  action="{{ route('professional.store') }}" enctype="multipart/form-data">
  ...
  <div class="row">
      ...
      <div class="col-md-5">
                        <input required type="text" class="form-control" id="services" name="services" value="{{ old('services') }}">
                    </div>
        </div>
      </div> 
