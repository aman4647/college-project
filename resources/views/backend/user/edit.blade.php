            ...
            <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="radio" @if($user->role==1) checked="checked"  @endif id="admin" name="role" value="1">
                            <label for="admin">Admin</label>
                            
                            <input type="radio" @if($user->role!=1) checked="checked" @endif id="customer" name="role" value="0">
